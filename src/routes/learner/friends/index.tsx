...
function FriendsPage() {
  ...
  const [selectedIndex, setSelectedIndex] = useState<string | number | null>(
    null
  );
  ...
  let isLoading = false;
  if (typeFriend === "friends") isLoading = isLoadingFriends;
  else if (typeFriend === "request") isLoading = isLoadingPending;
  else if (typeFriend === "leaderboard") isLoading = isLoadingLeaderboard;

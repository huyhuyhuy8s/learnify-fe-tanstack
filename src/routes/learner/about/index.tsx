...
function AboutPage() {
  return (
    <div className="w-full min-h-screen px-6 py-4" style={{ background: "#eef3ee" }}>

      {/* ── Hero banner ── */}
      <div
        className="rounded-2xl px-10 py-10 mb-6 relative overflow-hidden"
        style={{
          background: "linear-gradient(135deg, #c8d8f8 0%, #dce8ff 50%, #d4eed4 100%)",
        }}
      >
        {/* Decorative blobs */}
        <div
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_340px] gap-4 mb-4">
        ...
        <div className="bg-white rounded-2xl p-7 shadow-sm">
          <h2 className="text-base font-bold text-gray-800 mb-1">Our Mission</h2>
          <p className="text-xs text-gray-400 font-medium uppercase tracking-wider mb-4">
            Why we build Learnify
          </p>
          <p className="text-sm text-gray-600 leading-relaxed mb-4">
            Learnify was born from a simple belief: learning should be personalized,
            engaging, and available to everyone. We combine curated expert content
            with AI-driven guidance to create an experience that adapts to each
            individual learner's pace and goals.
          </p>
          <p className="text-sm text-gray-600 leading-relaxed">
            From interactive mind-maps to streaks that keep you motivated, every
            feature is designed to help you build lasting knowledge — not just pass
            the next exam.
          </p>
          ...
          <div className="grid grid-cols-3 gap-3 mt-6 pt-6 border-t border-gray-50">
            {ABOUT_STATS.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="text-2xl font-bold text-[#2d4a3e] mb-0.5">{stat.value}</div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm flex flex-col gap-3">
          <div>
            <h2 className="text-base font-bold text-gray-800 mb-1">Our Values</h2>
            <p className="text-xs text-gray-400 font-medium uppercase tracking-wider mb-4">
              What drives us
            </p>
          </div>
          {ABOUT_VALUES.map((v) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <div className="text-sm font-bold text-gray-800 mb-0.5">{v.title}</div>
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, #2d4a3e 0%, #3d6b55 100%)" }}
      >
        <div>
          <h3 className="text-lg font-bold text-white mb-1">Want to get in touch?</h3>
          <p className="text-sm text-white/70">We'd love to hear from you — feedback, ideas, or just a hello.</p>
        </div>
        <a
